<a class="btn btn-danger" href="#" data-toggle="modal" data-target="#deleteModal{{$port->id}}">
...
<div class="modal fade" id="deleteModal{{$port->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content bg-danger">
        ...
        <h5 class="modal-title" id="exampleModalLabel">Portfolio | Delete</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">×</span>
        </button>
        </div>
        <div class="modal-body">
            <p>Are you sure to delete this <b>{{$port->port_title}}</b> ?</p>
        </div>
