          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit your portfolio to show up!</h3>
              ...
              <div class="card-body">
              <form action="/portfolio/{{$port->id}}" method="POST" enctype="multipart/form-data">
                @method('PUT')
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('port_title') is-invalid @enderror" name="port_title" id="port_title" placeholder="Portfolio Title" value="{{$port->port_title}}">
                            @error('port_title')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="port_info" id="summernote" class="form-control @error('port_info') is-invalid @enderror" cols="30" rows="10">{{$port->port_info}}</textarea>
                            @error('port_info')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <img src="{{ asset('images/'.$port->picture) }}" alt="" class="img-thumbnail img-preview">
                            @else
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('port_date') is-invalid @enderror" name="port_date" id="port_date" value="{{$port->port_date}}">
                            @error('port_date')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
