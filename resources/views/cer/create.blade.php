          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Add your certificate to show up!</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('cer_title') is-invalid @enderror" name="cer_title" id="cer_title" placeholder="Certificate Title" value="{{old('cer_title')}}">
                            @error('cer_title')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="cer_info" id="summernote" class="form-control @error('cer_info') is-invalid @enderror" cols="30" rows="10">{{old('cer_info')}}</textarea>
                            @error('cer_info')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control @error('cer_date') is-invalid @enderror" name="cer_date" id="cer_date" value="{{old('cer_date')}}">
                            @error('cer_date')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
