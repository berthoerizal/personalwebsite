          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit your certificate to show up!</h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('cer_title') is-invalid @enderror" name="cer_title" id="cer_title" placeholder="Certificate Title" value="{{$cer->cer_title}}">
                            @error('cer_title')
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="cer_info" id="summernote" class="form-control @error('cer_info') is-invalid @enderror" cols="30" rows="10">{{$cer->cer_info}}</textarea>
                            @error('cer_info')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2">
                            @if ($cer->picture!=NULL)
                            <img src="{{ asset('images/'.$cer->picture) }}" alt="" class="img-thumbnail img-preview">
                            @else
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="cer_date">Date</label>
                            <input type="date" class="form-control @error('cer_date') is-invalid @enderror" name="cer_date" id="cer_date" value="{{$cer->cer_date}}">
                            @error('cer_date')
                            <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
